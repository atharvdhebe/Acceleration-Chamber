  ...
  <footer>
    <div class="footer">
      ...
      <div class="footer-links">
        <h3>Social Media</h3>
        <ul class="social-media">
          <li><i class="bi bi-envelope"></i><a href="mailto:accelerationchamber@gmail.com">Email Us</a></li>
          <li><i class="bi bi-instagram"></i><a href="https://www.instagram.com/accelerationchamber" target="_blank">Instagram</a></li>
          <li><i class="bi bi-linkedin"></i><a href="https://www.linkedin.com/company/accelerationchamber" target="_blank">LinkedIn</a></li>
          <li><i class="bi bi-twitter"></i><a href="https://twitter.com/accel_chamber" target="_blank">Twitter</a></li>
        </ul>
      </div>
      ...
      <div class="contact-info">
        <h3>Contact Info</h3>
        <ul>
          <li><i class="bi bi-envelope-at-fill"></i><a href="mailto:accelerationchamber@gmail.com">accelerationchamber@gmail.com</a></li>
          <li><i class="bi bi-telephone-fill"></i> +91 9552724103</li>
          <li><i class="bi bi-geo-alt-fill"></i> Pune, Maharashtra</li>
        </ul>
      </div>

      <div class="footer-map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3783.1613018789467!2d73.83218307496291!3d18.521611582572127!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2bf9eec256d2f%3A0xd29c7a0cc504b3cf!2sBMCC%20BBA%2CBBA-CA%2CBBA-IB%20Section!5e0!3m2!1sen!2sin!4v1745134577680!5m2!1sen!2sin" allowfullscreen="" loading="lazy"></iframe>
      </div>
    </div>
