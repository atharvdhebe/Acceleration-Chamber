...
<div class="tab-container">
  ...
  <div class="row">
    <div class="col-md-8 tab-buttons mx-auto">
      ...
      <button class="semester-btn" data-toggle="collapse" data-target="#sem1">
        <span><i class="fas fa-laptop-code"></i> Semester 1</span>
        <i class="fas fa-chevron-down"></i>
      </button>
      <div id="sem1" class="collapse dropdown-subjects">
        <a href="maths1.php">Mathematics I</a>
        <a href="progFundamentals.php">Programming Fundamentals</a>
        <a href="digital.php">Digital Logic</a>
        <a href="english.php">English</a>
      </div>

   
      <button class="semester-btn" data-toggle="collapse" data-target="#sem2">
        <span><i class="fas fa-chart-line"></i> Semester 2</span>
        <i class="fas fa-chevron-down"></i>
      </button>
      <div id="sem2" class="collapse dropdown-subjects">
      ...
      <button class="semester-btn" data-toggle="collapse" data-target="#sem3">
        <span><i class="fas fa-database"></i> Semester 3</span>
        <i class="fas fa-chevron-down"></i>
      </button>
      <div id="sem3" class="collapse dropdown-subjects">
        <a href="#">Database Management</a>
        <a href="#">Object-Oriented Programming</a>
      </div>

  
      <button class="semester-btn" data-toggle="collapse" data-target="#sem4">
        <span><i class="fas fa-network-wired"></i> Semester 4</span>
        <i class="fas fa-chevron-down"></i>
      </button>
      <div id="sem4" class="collapse dropdown-subjects">
      ...
      <button class="semester-btn" data-toggle="collapse" data-target="#sem5">
        <span><i class="fas fa-project-diagram"></i> Semester 5</span>
        <i class="fas fa-chevron-down"></i>
      </button>
      ...
      <button class="semester-btn" data-toggle="collapse" data-target="#sem6">
        <span><i class="fas fa-brain"></i> Semester 6</span>
        <i class="fas fa-chevron-down"></i>
      </button>
      ...
      <button class="semester-btn" data-toggle="collapse" data-target="#sem7">
        <span><i class="fas fa-robot"></i> Semester 7</span>
        <i class="fas fa-chevron-down"></i>
      </button>
      ...
      <button class="semester-btn" data-toggle="collapse" data-target="#sem8">
        <span><i class="fas fa-rocket"></i> Semester 8</span>
        <i class="fas fa-chevron-down"></i>
      </button>
